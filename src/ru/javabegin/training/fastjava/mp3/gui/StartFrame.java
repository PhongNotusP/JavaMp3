...
public class StartFrame extends javax.swing.JFrame implements PlayControlListener {
    ...
    private double posValue = 0.0; // vị trí 

    private boolean moveAutomatic = false;// false - phát nhạc thì thanh truot di chuyển, true - di chuyển bằng tay
    ...
    private void searchSong() {
        ...
        if (!playList.search(name)) {
            JOptionPane.showMessageDialog(this, "Tìm kiếm theo kí tự \'" + name + "\' không kết quả");
    ...
    private void initComponents() {
        ...
        panelMain.setBorder(javax.swing.BorderFactory.createTitledBorder(null));
        ...
        btnAddSong.setToolTipText("Thêm bài");
        ...
        btnDeleteSong.setToolTipText("Xóa bài");
        ...
        btnStopSong.getAccessibleContext().setAccessibleDescription("stop");
        btnPauseSong.getAccessibleContext().setAccessibleDescription("tạm ngừng");
        btnPlaySong.getAccessibleContext().setAccessibleDescription("Phát");
        btnNextSong.getAccessibleContext().setAccessibleDescription("tiến 1 bài");
        slideVolume.getAccessibleContext().setAccessibleDescription("âm lượng");
        tglbtnVolume.getAccessibleContext().setAccessibleDescription("tắt âm");
        btnPrevSong.getAccessibleContext().setAccessibleDescription("lùi 1 bài");
        slideProgress.getAccessibleContext().setAccessibleDescription("");

        panelSearch.setBorder(javax.swing.BorderFactory.createTitledBorder(null));
        ...
        btnSearch.getAccessibleContext().setAccessibleName("Tìm");
        btnSearch.getAccessibleContext().setAccessibleDescription("Tìm 1 bài hát");
        ...
        menuChangeSkin.setText("Chọn khung");
    ...
    private void btnAddSongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddSongActionPerformed
        ...
        int result = fileChooser.showOpenDialog(this);// result lưu trữ tập tin được chọn hay không

        if (result == JFileChooser.APPROVE_OPTION) {// Nếu được chọn OK hoặc YES
    ...
    private void menuSavePlaylistActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuSavePlaylistActionPerformed
        ...
        if (result == JFileChooser.APPROVE_OPTION) {// nếu dc bấm OK hoac YES
            File selectedFile = fileChooser.getSelectedFile();
            if (selectedFile.exists()) {// nếu file đã tồn tại

                int resultOvveride = JOptionPane.showConfirmDialog(this, "File tồn tại", "Ghi đè", JOptionPane.YES_NO_CANCEL_OPTION);
                switch (resultOvveride) {
                    case JOptionPane.NO_OPTION:
                        menuSavePlaylistActionPerformed(evt);// mở cửa sổ lưu file
                        return;
    ...
    private void menuOpenPlaylistActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuOpenPlaylistActionPerformed
        FileUtils.addFileFilter(fileChooser, playlistFileFilter);
        int result = fileChooser.showOpenDialog(this);// result lưu kết quả tập tin có được chọn hay không

        if (result == JFileChooser.APPROVE_OPTION) {// nếu được ấn OK hoặc YES
